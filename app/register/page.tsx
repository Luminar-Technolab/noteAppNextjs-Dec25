        ...
        <div className="flex items-center justify-center min-h-screen">
            <div className="bg-blue-400 p-5 rounded w-100">
                ...
                <div className="mt-5 mb-3 w-full">
                    <input type="text" placeholder="Name" className="rounded bg-gray-100 p-3 w-full" />
                </div>
                <div className="mb-3 w-full">
                    <input type="email" placeholder="Email" className="rounded bg-gray-100 p-3 w-full" />
                </div>
                <div className=" mb-3 w-full">
                ...
                <div className=" mb-3 flex text-white items-center">
                    <button className="bg-blue-700 rounded px-3 py-2 text-white">Register</button>
